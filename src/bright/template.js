module.exports = {
  ...
  "type": "light",
  "colors": {
    "focusBorder": "{{ ui.border }}{{ alpha.low }}",
    "foreground": "{{ ui.darkText }}",
    "widget.shadow": "{{ ui.shadow }}{{ alpha.medLow }}",
    "selection.background": "{{ ui.tertiaryAccent }}{{ alpha.med }}",
    ...
    "scrollbar.shadow": "{{ ui.shadow }}{{ alpha.medLow }}",
    "scrollbarSlider.activeBackground": "{{ ui.accentAlt }}{{ alpha.high }}",
    "scrollbarSlider.background": "{{ ui.accentAlt }}{{ alpha.med }}",
    "scrollbarSlider.hoverBackground": "{{ ui.accentAlt }}{{ alpha.highMed }}",
    "badge.foreground": "{{ ui.darkText }}",
    "badge.background": "{{ ui.accent }}",
    "progressBar.background": "{{ ui.secondaryAccentAlt }}",
    "list.activeSelectionBackground": "{{ ui.accent }}{{ alpha.med }}",
    "list.activeSelectionForeground": "{{ ui.darkText }}",
    "list.dropBackground": "{{ ui.accentAlt }}{{ alpha.med }}",
    "list.focusBackground": "{{ ui.accent }}{{ alpha.med }}",
    "list.focusForeground": "{{ ui.darkText }}",
    "list.highlightForeground": "{{ ui.secondaryAccentAlt }}",
    "list.hoverBackground": "{{ ui.accent }}{{ alpha.med }}",
    "list.hoverForeground": "{{ ui.darkText }}",
    "list.inactiveSelectionBackground": "{{ ui.accent }}{{ alpha.medLow }}",
    "list.inactiveSelectionForeground": "{{ ui.darkText }}",
    ...
    "editorLineNumber.foreground": "{{ ui.darkText }}{{ alpha.low }}",
    "editorLineNumber.activeForeground": "{{ ui.darkText }}{{ alpha.med }}",
    "editorCursor.background": "{{ ui.background }}",
    "editorCursor.foreground": "{{ ui.secondaryAccentAlt }}",
    "editor.selectionBackground": "{{ ui.accent }}{{ alpha.med }}",
    "editor.selectionHighlightBackground": "{{ ui.accentAlt }}{{ alpha.med }}",
    ...
    "editorOverviewRuler.border": "{{ ui.accent }}{{ alpha.low }}",
    "editorOverviewRuler.findMatchForeground": "{{ ui.accentAlt }}",
    "editorOverviewRuler.modifiedForeground": "{{ ui.modified }}{{ alpha.highMed }}",
    "editorOverviewRuler.addedForeground": "{{ ui.positive }}{{ alpha.highMed }}",
    "editorOverviewRuler.deletedForeground": "{{ ui.negative }}{{ alpha.highMed }}",
    "editorOverviewRuler.errorForeground": "{{ ui.negative }}{{ alpha.high }}",
    "editorOverviewRuler.warningForeground": "{{ ui.warning }}{{ alpha.highMed }}",
    "editorOverviewRuler.bracketMatchForeground": "{{ ui.darkText }}{{ alpha.highMed }}",
    "editorError.foreground": "{{ ui.negative }}",
    "editorWarning.foreground": "{{ ui.warning }}{{ alpha.highMed }}",
    "editorUnnecessaryCode.opacity": "#000000{{ alpha.highMed }}",
    ...
    "peekView.border": "{{ ui.border }}{{ alpha.low }}",
    ...
    "statusBar.foreground": "{{ ui.darkText }}{{ alpha.highMed }}",
    ...
    "terminal.foreground": "{{ ui.darkText }}",
    ...
    "terminal.selectionBackground": "{{ ui.accentAlt }}{{ alpha.med }}",
    "terminalCursor.background": "{{ ui.darkText }}",
    "terminalCursor.foreground": "{{ ui.accentAlt }}{{ alpha.highMed }}",
    ...
    "gitDecoration.ignoredResourceForeground": "{{ ui.darkText }}{{ alpha.medLow }}",
  ...
  "tokenColors": [
    {
      ...
      "scope": "comment",
      "settings": {
        "foreground": "{{ syntax.black }}{{ alpha.med }}",
        "fontStyle": "italic"
      }
    },
    {
    ...
    },
    {
      ...
      "scope": "markup.quote",
      "settings": {
        "foreground": "{{ syntax.tango }}{{ alpha.highMed }}",
        "fontStyle": "italic"
      }
    },
    {
    ...
    },
    {
      ...
      "settings": {
        "foreground": "{{ syntax.crimson }}{{ alpha.highMed }}",
        "fontStyle": "{{ tagStyle }}"
      }
    },
    {
